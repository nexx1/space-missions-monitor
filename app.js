...
const MISSION_INFO = {
    artemis_ii: [[2026], 'Первый пилотируемый облёт Луны за 54 года. 4 астронавта на корабле Orion.'],
    curiosity: [[2012], 'Исследование обитаемости Марса, геологии и климата в кратере Гейла.'],
    perseverance: [[2021], 'Поиск следов древней жизни, сбор образцов грунта для возврата на Землю.'],
    spirit: [[2004, 2010], 'Поиск следов воды в кратере Гусева. Работал в 20 раз дольше плана.'],
    opportunity: [[2004, 2018], 'Исследование минералов и геологии. Рекорд дальности — 45 км.'],
    lro: [[2009], 'Детальное картографирование Луны, поиск ресурсов для будущих миссий.'],
    chandrayaan3: [[2023, 2023], 'Первая посадка у южного полюса Луны. Обнаружение серы в грунте.'],
    yutu2: [[2019], 'Первый ровер на обратной стороне Луны. Рекорд по длительности работы.'],
    zhurong: [[2021, 2022], 'Первый неамериканский ровер на Марсе. Исследование Utopia Planitia.'],
    slim: [[2024, 2024], 'Точная посадка на Луну (100 м от цели). Мини-роверы LEV-1 и SORA-Q.'],
    lunokhod1: [[1970, 1971], 'Первый в мире ровер на другом небесном теле. 10.5 км по Луне.'],
    lunokhod2: [[1973, 1973], 'Рекорд дальности 39 км, державшийся 41 год. 80 000+ фото.'],
    sojourner: [[1997, 1997], 'Первый марсоход. 11.5 кг, работал 85 дней вместо запланированных 7.'],
    ingenuity: [[2021, 2024], 'Первый полёт на другой планете. 72 полёта, 17 км суммарно.'],
    phoenix: [[2008, 2008], 'Подтверждение водяного льда в грунте северного полюса Марса.'],
    insight: [[2018, 2022], 'Первое обнаружение марсотрясений. 1300+ сейсмических событий.'],
    viking: [[1976, 1982], 'Первые фото с поверхности Марса. Эксперименты по поиску жизни.'],
    apollo_lrv: [[1971, 1972], 'Единственный ровер с экипажем на другом небесном теле. Макс. 18 км/ч.'],
    huygens: [[2005, 2005], 'Единственная посадка во внешней Солнечной системе — на спутник Сатурна Титан.'],
    philae: [[2014, 2016], 'Первая посадка на комету. Обнаружение органических молекул на 67P.'],
    venera: [[1975, 1982], 'Единственные фото с поверхности Венеры. Работа при 462°C и 90 атм.'],
    cassini: [[2004, 2017], 'Открытие океанов на Энцеладе и озёр на Титане. 450 000+ снимков.'],
    juno: [[2016], 'Изучение атмосферы и магнитосферы Юпитера. Пролёты Ио, Европы, Ганимеда.'],
    new_horizons: [[2015], 'Первые детальные снимки Плутона и Харона. Пролёт Аррокота (2019).'],
    voyager: [[1977], 'Пролёт всех газовых гигантов. «Бледная голубая точка». Межзвёздное пространство.'],
    osiris_rex: [[2016], 'Сбор 121 г грунта с астероида Бенну, доставка на Землю. Летит к Апофису.'],
    hayabusa2: [[2018], 'Сбор подповерхностного грунта астероида Рюгу. Доставка 5.4 г на Землю.'],
    messenger: [[2011, 2015], 'Полная карта Меркурия. Обнаружение водяного льда в полярных кратерах.'],
    dawn: [[2011, 2018], 'Первый аппарат на орбите двух внеземных тел — Весты и Цереры.'],
    mro: [[2006], 'Самые детальные снимки Марса (0.3 м/пиксель). Обнаружение сезонных потоков.'],
    chang_e3: [[2013, 2016], 'Первая мягкая посадка на Луну с 1976 года. Первый китайский луноход.'],
    mars_express: [[2003], 'Орбитальное исследование Марса. Обнаружение подлёдного озера.'],
    maven: [[2014], 'Изучение верхней атмосферы Марса и потери газов в космос.'],
    mars_odyssey: [[2001], 'Самый долгоработающий аппарат на орбите Марса. Карта водорода.'],
    mangalyaan: [[2014, 2022], 'Первая межпланетная миссия Индии. Успех с первой попытки.'],
    exomars_tgo: [[2016], 'Поиск метана и других газов в атмосфере Марса. Ретранслятор.'],
    chandrayaan1: [[2008, 2009], 'Первая индийская лунная миссия. Подтверждение воды на Луне.'],
    kaguya: [[2007, 2009], 'Детальная съёмка Луны в HD. Гравитационная карта обратной стороны.'],
    grail: [[2012, 2012], 'Точнейшая гравитационная карта Луны. Два аппарата в связке.'],
    lcross: [[2009, 2009], 'Удар по кратеру у южного полюса Луны. Подтверждение водяного льда.'],
    odysseus_im1: [[2024, 2024], 'Первый частный аппарат на Луне (Intuitive Machines). Опрокинулся при посадке.'],
    magellan: [[1990, 1994], 'Радарная карта 98% поверхности Венеры с разрешением ~100 м.'],
    akatsuki: [[2015], 'Изучение атмосферы Венеры. Суперротация и волновые структуры в облаках.'],
    venus_express: [[2006, 2014], 'Исследование атмосферы и климата Венеры с орбиты.'],
    galileo: [[1995, 2003], 'Первый орбитальный аппарат у Юпитера. Открытие океана на Европе.'],
    europa_clipper: [[2024], 'Детальное исследование Европы — ледяного спутника Юпитера с океаном.'],
    juice: [[2023], 'Исследование ледяных спутников Юпитера: Ганимед, Каллисто, Европа.'],
    parker: [[2018], 'Ближайший к Солнцу аппарат. Пролёт через солнечную корону.'],
    soho: [[1996], 'Наблюдение Солнца из точки Лагранжа L1. Открытие 4000+ комет.'],
    solar_orbiter: [[2020], 'Снимки Солнца с рекордным разрешением. Изучение полярных областей.'],
    hayabusa1: [[2005, 2010], 'Первый возврат грунта с астероида (Итокава). Пионер технологии.'],
    stardust: [[2004, 2011], 'Сбор частиц кометы Вильд-2 и межзвёздной пыли. Возврат на Землю.'],
    deep_impact: [[2005, 2013], 'Удар по комете Темпель-1 для изучения внутреннего состава.'],
    near_shoemaker: [[2000, 2001], 'Первая посадка на астероид (Эрос). Орбитальное исследование.'],
    lucy: [[2021], 'Исследование троянских астероидов Юпитера. 12-летняя миссия.'],
    dart: [[2022, 2022], 'Первый тест планетарной защиты. Изменение орбиты Диморфоса.'],
    hubble: [[1990], 'Революция в астрономии. Глубокие поля, тёмная энергия, экзопланеты.'],
    jwst: [[2022], 'Самый мощный космический телескоп. Инфракрасный взгляд на раннюю Вселенную.'],
    chandra: [[1999], 'Рентгеновская обсерватория. Чёрные дыры, остатки сверхновых, скопления галактик.'],
    spitzer: [[2003, 2020], 'Инфракрасный телескоп. Экзопланеты, протопланетные диски, далёкие галактики.'],
    chang_e5: [[2020, 2020], 'Первый возврат лунного грунта с 1976 года. 1.73 кг образцов.'],
    chang_e6: [[2024, 2024], 'Первый возврат грунта с обратной стороны Луны.'],
    beresheet: [[2019, 2019], 'Первая частная попытка посадки на Луну (Израиль). Разбился при посадке.'],
};
...
function generatePanels() {
    ...
    Object.entries(MISSIONS).forEach(([id, m], i) => {
        ...
        const desc = getMissionDesc(id);
        const descHtml = desc ? `<p class="mission-desc">${desc}</p>` : '';
